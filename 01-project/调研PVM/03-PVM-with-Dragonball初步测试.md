...
测试结果, `dbs-cli` 进程立即返回，dmesg 报告 [[03-PVM-with-Dragonball初步测试#附录1 dragonball + PVM dmesg报错| 附录1]] 中的错误
# 使用kata测试
...
> [!error]  同样报告 [[03-PVM-with-Dragonball初步测试#附录1 dragonball + PVM dmesg报错| 附录1]]  中的错误

# 结论

> [!bug]  `dragonball + PVM` 会报告和 [[01-project/调研PVM/cloud-hypervisor 启动PVM虚拟机报错|cloud-hypervisor]] 相同的错误。
