---
title: "obsidian-admonition/docs/options.md at main"
source: "https://github.com/ebullient/obsidian-admonition/blob/main/docs/options.md"
author:
published:
created: 2026-06-24
description: "Adds admonition block-styled content to Obsidian.md  - obsidian-admonition/docs/options.md at main · ebullient/obsidian-admonition"
tags:
  - "clippings"
---
## Admonition Options

[![Admonitions demo](https://github.com/ebullient/obsidian-admonitions/raw/main/publish/gifs/all.gif?raw=true)](https://github.com/ebullient/obsidian-admonitions)
...
[![Default Admonition Note](https://github.com/ebullient/obsidian-admonitions/raw/main/publish/images/default.png?raw=true)](https://github.com/ebullient/obsidian-admonitions/blob/main/publish/images/default.png?raw=true)
...
[![Rendered title markdown](https://github.com/ebullient/obsidian-admonitions/raw/main/publish/images/rendered-title-markdown.png?raw=true)](https://github.com/ebullient/obsidian-admonitions/blob/main/publish/images/rendered-title-markdown.png?raw=true)
...
[![No title](https://github.com/ebullient/obsidian-admonitions/raw/main/publish/images/no-title.png?raw=true)](https://github.com/ebullient/obsidian-admonitions/blob/main/publish/images/no-title.png?raw=true)
...
You can set all admonitions to be collapsible by default in the [settings](https://github.com/ebullient/obsidian-admonition/blob/main/docs/settings.md).

[![Collapse demo](https://github.com/ebullient/obsidian-admonitions/raw/main/publish/gifs/collapse.gif?raw=true)](https://github.com/ebullient/obsidian-admonitions/blob/main/publish/gifs/collapse.gif?raw=true)
