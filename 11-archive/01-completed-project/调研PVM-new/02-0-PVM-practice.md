...
share_updated: 2026-08-05T15:08:05+08:00
---
# overflow
...
```
* 解压安装containerd: `tar /usr/local -xvf containerd-2.3.3-linux-amd64.tar.gz`
### config Containerd
...
> [!todo] 
> ![[11-archive/01-completed-project/调研PVM-new/02-a-pvm-get-started-with-kata#^691d34]]
> 我们这里暂时先不验证这个问题
## 配置 Cloud Hypervisor
...
原因是:
![[11-archive/01-completed-project/调研PVM-new/02-a-pvm-get-started-with-kata#^d17536]]
...
[[11-archive/01-completed-project/调研PVM-new/cloud-hypervisor 启动PVM虚拟机报错]]

而链接<sup>1</sup>中暴露了 `CH`的另一个问题。
![[11-archive/01-completed-project/调研PVM-new/02-a-pvm-get-started-with-kata#^7953de]] 
![[11-archive/01-completed-project/调研PVM-new/02-a-pvm-get-started-with-kata#^8ddd3a]]
