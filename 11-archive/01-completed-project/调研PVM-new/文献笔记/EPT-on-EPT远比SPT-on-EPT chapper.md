> [!PDF|important] [[01-project/调研PVM/pdf/sosp2023-pvm-paper.pdf#page=5&selection=609,38,634,43&color=important|📖 EPT-on-EPT 第一阶段 比 SPT-on-EPT 第一阶段 world switch次数减少接近一倍]]
...
> [!PDF|note] [[01-project/调研PVM/pdf/sosp2023-pvm-paper.pdf#page=5&selection=644,35,657,21&color=note|📖 EPT-on-EPT 第二阶段 比 SPT-on-EPT trap 次数减少一倍]]
> > it adds one more 𝐿0 trap and two more world switches. 
> 
> EPT-on-EPT 第二阶段仅仅只Trap一次.

> [!PDF|yellow] [[01-project/调研PVM/pdf/sosp2023-pvm-paper.pdf#page=5&selection=684,0,693,2&color=yellow|📖 结论: SPT-on-EPT比 EPT-on-EPT 会多更多的 world switch 次数]]
