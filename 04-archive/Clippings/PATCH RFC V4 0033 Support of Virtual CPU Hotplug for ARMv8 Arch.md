---
title: "[PATCH RFC V4 00/33] Support of Virtual CPU Hotplug for ARMv8 Arch"
source: "https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00354.html"
author:
published:
created: 2026-06-15
description:
...
\[[Date Prev](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00353.html)\]\[[Date Next](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00355.html)\]\[[Thread Prev](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00333.html)\]\[[Thread Next](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00355.html)\]\[\]\[\]

---

| **From**: | Salil Mehta |
| --- | --- |
| **Subject**: | \[PATCH RFC V4 00/33\] Support of Virtual CPU Hotplug for ARMv8 Arch |
| **Date**: | Wed, 9 Oct 2024 04:17:42 +0100 |
...
Architecture agnostic patch-set was merged with mainline in the last Qemu cycle.
This is an ARM architecture-specific patch and works with *near* latest Qemu
mainline.
...
**[UPCOMING]**
I’ve been working on improving the boot times of ARM/VMs using the hotplug
infrastructure proposed in this patch set. Stay tuned for upcoming patches that
leverage this infrastructure to drastically reduce VM boot times for 
*non-hotplug*
...
(*) Latest Qemu RFC V4 (Architecture Specific) patch set:
    https://github.com/salil-mehta/qemu.git virt-cpuhp-armv8/rfc-v4
(*) Older QEMU changes for vCPU hotplug can be cloned from below site:
    https://github.com/salil-mehta/qemu.git virt-cpuhp-armv8/rfc-{v1,v2,v3}
...
A. ARM Architecture *specific* patches:
   ...
   [Patch 1-9, 13, 14, 33] logic required during machine init.
   ...
   [Patch 10-12, 15-19] logic related to ACPI at machine init time.
   ...
   [Patch 20-28] logic required during vCPU hot-(un)plug.
...
Salil Mehta (29):
  ...
  arm/virt: Create GED device before *disabled* vCPU Objects are
    destroyed
  ...
  hw/acpi: Simulate *persistent* vCPU presence to Guest in ACPI
    _STA.{PRES,ENA} Bits
 ...
 tcg/region.c                       |  14 +
 tcg/tcg.c                          |  46 +-
 41 files changed, 1884 insertions(+), 375 deletions(-)
...
| \[Prev in Thread\] | **Current Thread** | \[[Next in Thread](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00355.html)\] |
| --- | --- | --- |

- **\[PATCH RFC V4 00/33\] Support of Virtual CPU Hotplug for ARMv8 Arch**, *Salil Mehta* **<=**
	- **[\[PATCH RFC V4 01/33\] arm/virt, target/arm: Add new ARMCPU {socket, cluster, core, thread}-id property](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00355.html)**, *Salil Mehta*, 2024/10/08
		- **[Re: \[PATCH RFC V4 01/33\] arm/virt,target/arm: Add new ARMCPU {socket,cluster,core,thread}-id property](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00422.html)**, *Miguel Luis*, 2024/10/10
		- **[\[PATCH RFC V4 02/33\] cpu-common: Add common CPU utility for possible vCPUs](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00356.html)**, *Salil Mehta*, 2024/10/08
		- **[Re: \[PATCH RFC V4 02/33\] cpu-common: Add common CPU utility for possible vCPUs](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00423.html)**, *Miguel Luis*, 2024/10/10
			- **[RE: \[PATCH RFC V4 02/33\] cpu-common: Add common CPU utility for possible vCPUs](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00425.html)**, *Salil Mehta*, 2024/10/11
		- **[\[PATCH RFC V4 03/33\] hw/arm/virt: Disable vCPU hotplug for \*unsupported\* Accel or GIC Type](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00357.html)**, *Salil Mehta*, 2024/10/08
		- **[\[PATCH RFC V4 04/33\] hw/arm/virt: Move setting of common vCPU properties in a function](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00358.html)**, *Salil Mehta*, 2024/10/08
		- **[\[PATCH RFC V4 05/33\] arm/virt, target/arm: Machine init time change common to vCPU {cold|hot}-plug](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00359.html)**, *Salil Mehta*, 2024/10/08
		- **[\[PATCH RFC V4 06/33\] arm/virt, kvm: Pre-create disabled possible vCPUs @machine init](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00360.html)**, *Salil Mehta*, 2024/10/08
		- **[\[PATCH RFC V4 07/33\] arm/virt, gicv3: Changes to pre-size GIC with possible vCPUs @machine init](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00361.html)**, *Salil Mehta*, 2024/10/08

---

- Prev by Date: **[\[PATCH v3 18/20\] target/arm: Move device detection earlier in get\_phys\_addr\_lpae](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00353.html)**
- Next by Date: **[\[PATCH RFC V4 01/33\] arm/virt, target/arm: Add new ARMCPU {socket, cluster, core, thread}-id property](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00355.html)**
- Previous by thread: **[\[PATCH v3 00/20\] accel/tcg: Introduce tlb\_fill\_align hook](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00333.html)**
- Next by thread: **[\[PATCH RFC V4 01/33\] arm/virt, target/arm: Add new ARMCPU {socket, cluster, core, thread}-id property](https://lists.gnu.org/archive/html/qemu-arm/2024-10/msg00355.html)**
- Index(es):